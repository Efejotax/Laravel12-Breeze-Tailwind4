...
<h1 class="text-4xl text-blue-900 font-semibold mb-8 text-center">Página Home simple</h1>
    <h2 class="text-3xl font-semibold mb-8 text-center">Path: /views/app/front/home</h2>
    <h3 class="text-3xl text-blue-900 font-semibold mb-8 text-center">Nuestras tarjetas</h3>
